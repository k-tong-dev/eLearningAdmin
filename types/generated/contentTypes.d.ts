...
export interface ApiCourseContentCourseContent
  ...
  attributes: {
    ...
    preview_duration: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    purchase_count: Schema.Attribute.Decimal &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCourseCourseCourseCourse
  ...
  attributes: {
    ...
    preview_available: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<false>;
    preview_duration: Schema.Attribute.Decimal &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCourseMaterialCourseMaterial
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    free_text: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    price: Schema.Attribute.Decimal &
      ...
      Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['Video', 'PDF', 'URL', 'Free Text']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
